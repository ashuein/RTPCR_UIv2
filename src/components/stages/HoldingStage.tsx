...
interface HoldingStageProps {
  stage: Stage;
  width: number;
  height: number;
  padding: number;
  onStepSelect: (stepIndex: number) => void;
  onTemperatureChange: (stepIndex: number, temp: number) => void;
  ...
  return (
    <g>
      ...
      <path
        ...
        strokeWidth="3"
        fill="none"
        opacity={selectedLane === 1 ? 1 : 0.3}
        pointerEvents={selectedLane === 1 ? 'auto' : 'none'}
      />
      ...
      <path
        ...
        strokeWidth="3"
        fill="none"
        opacity={selectedLane === 2 ? 1 : 0.3}
        pointerEvents={selectedLane === 2 ? 'auto' : 'none'}
      />
      ...
      {stage.steps.map((step, index) => (
        <React.Fragment key={index}>
          <g 
            ...
            style={{ 
              cursor: selectedLane === 1 ? 'ns-resize' : 'not-allowed',
              pointerEvents: selectedLane === 1 ? 'auto' : 'none'
            }}
            opacity={selectedLane === 1 ? 1 : 0.3}
          >
          ...
          <g 
            ...
            style={{ 
              cursor: selectedLane === 2 ? 'ns-resize' : 'not-allowed',
              pointerEvents: selectedLane === 2 ? 'auto' : 'none'
            }}
            opacity={selectedLane === 2 ? 1 : 0.3}
          >
